...
prisondata <- prisondata %>% mutate(reoffender = case_when(number_of_offences == 1 ~ FALSE, number_of_offences != 1 ~ TRUE))
...
- We wanted to investigate whether the violence of the prisoner (based on whether they committed a violent crime or not) had any correlation with reoffending.
...
# Which factors effect the violence of the prisoner?

- Prison Type and Reoffending 
